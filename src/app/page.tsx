...
const Home_page = () => {
  return (
    <div className="bg h-screen">
      <img src="/spin.png" alt="" className="absolute h-20 left-[46.5vw] top-4 animate-spin" />
      ...
      <img src="/lotus.png" alt="" className="absolute left-[92vw] h-20 top-[50vw] animate-spin" />
      <img src="/ring.png" alt="" className="absolute left-[15vw] h-28 top-[27vw] animate-spin" />
